...
class RowMaterialDetail extends StatefulWidget {
  final Map content;

  const RowMaterialDetail({
    super.key,
    required this.content,
  });

  @override
  State<RowMaterialDetail> createState() => _RowMaterialDetailState();
}

class _RowMaterialDetailState extends State<RowMaterialDetail> {
  Map selectData = {};
